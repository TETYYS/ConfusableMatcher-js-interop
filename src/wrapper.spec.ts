...
describe('Unit Tests', () => {
    ...
    test('Test2', () => {
        ...
        expect(r.index == 0 || r.index == 4).toBeTruthy();
        expect(r.len == 3 || r.len == 4).toBeTruthy();

        r = m.indexOf('VAVOVAVO', 'VV', { matchRepeating: false, startIndex: 4 });
        expect(r.index).toEqual(4);
        expect(r.len == 3 || r.len == 4).toBeTruthy();

        r = m.indexOf('VAVOVAVO', 'VV', { matchRepeating: false, startIndex: 2 });
        expect(r.index == 2 || r.index == 4).toBeTruthy();
        expect(r.len == 3 || r.len == 4).toBeTruthy();
    ...
    test('Test7', () => {
        ...
        expect((r.index == 64 && r.len == 57) || (r.index == 89 && r.len == 32)).toBeTruthy();
    });
    ...
    test('Test8', () => {
        ...
        expect(r.index).toEqual(5);
        expect(r.len).toEqual(397);
    });
    ...
    test('Test9', () => {
        ...
        expect(r.index == 0 || r.index == 1).toBeTruthy();
        expect(r.len).toEqual(1);
    });
    ...
    test('Test9.1', () => {
        ...
        expect(r.index).toEqual(0);
        expect(r.len >= 547 && r.len <= 567).toBeTruthy();
    });
    ...
    test('Test13', () => {
        const m = new ConfusableMatcher();
        expect(() => m.addMapping('', '?', false)).toThrow();
        expect(() => m.addMapping('?', '', false)).toThrow();
        expect(() => m.addMapping('', '', false)).toThrow();
        expect(() => m.addMapping('\x00', '?', false)).toThrow();
        expect(() => m.addMapping('?', '\x00', false)).toThrow();
        expect(() => m.addMapping('\x01', '?', false)).toThrow();
        expect(() => m.addMapping('?', '\x01', false)).toThrow();
        expect(() => m.addMapping('\x00', '\x01', false)).toThrow();
        expect(() => m.addMapping('\x00', '\x00', false)).toThrow();
        expect(() => m.addMapping('\x01', '\x00', false)).toThrow();
        expect(() => m.addMapping('\x01', '\x01', false)).toThrow();
        expect(() => m.addMapping('\x01\x00', '\x00\x01', false)).toThrow();
        expect(() => m.addMapping('A\x00', '\x00A', false)).toThrow();
        expect(() => m.addMapping('\x01\x00', '\x00\x01', false)).toThrow();
        expect(() => m.addMapping('A\x00', 'A\x01', false)).not.toThrow();
        expect(() => m.addMapping('A\x01', 'A\x00', false)).not.toThrow();
        expect(() => m.addMapping('A\x00', 'A\x00', false)).not.toThrow();
        expect(() => m.addMapping('A\x01', 'A\x01', false)).not.toThrow();
    });
    ...
    test('Test22', () => {
        ...
        const KEY = '123';
        const m = new ConfusableMatcher(
            Array.from<unknown, ICMMapping>({ length: COUNT }, (i, x) => [KEY, x.toString()]),
            [],
            false
        );
    ...
    test('Test25', () => {
        ...
        expect(-2).toEqual(r.index);
        expect(-2).toEqual(r.len);
...
function getDefaultMap(): ICMMapping[] {
    const map: ICMMapping[] = [
        ['N', '/[()[]]/'],
        ['N', '\u{000000f1}'],
        ['N', '|\\|'],
